...
namespace NewyorkLotteryPCL.Historical
{
    ...
    public partial class MegamillionsHistoriquePage : ContentPage
    {
        IAdInterstitial adInterstitial;

        public MegamillionsHistoriquePage()
        {
            InitializeComponent();
        ...
        private async Task callAPI()
        {
            ...
            try
            {
                var megamillions = new List<Megamillions>();
                HttpClient client = new HttpClient();
                var uri = new Uri("http://mobixapp.com/loto_usa_api/Api/getAllMega_millions");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    for (int i = 0; i < output.Count; i++)
                    {
                        ...
                        megamillions.Add(new Megamillions { n1 = n1, n2 = n2, n3 = n3, n4 = n4, n5 = n5, n6 = n6, n7 = n7, tirage_du = tirage_du });

                    }
                    listView.ItemsSource = megamillions;
